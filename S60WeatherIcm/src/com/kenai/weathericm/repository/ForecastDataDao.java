...
public interface ForecastDataDao {
     ...
     * to be read later by given {@code id}. It's caller responsibility to make
     ...
     * @return {@code true} if the {@link ForecastData} has been successfully
    ...
    /**
     * Reads the {@link ForecastData} from the persistent storage.
     ...
     * already exists in the storage that has same {@code id} or the {@code
     ...
     * @return {@link true} if the operation has been successful, {@code false} otherwise.
     */
